          ...
          <Dialog open={open} onOpenChange={onClose}>
               <DialogContent className="max-w-4xl sm:max-w-3xl w-full">
                    <DialogHeader className="flex flex-col">
                         <DialogTitle className="text-2xl font-semibold">{unit.name}</DialogTitle>
                    ...
                    {loading ? (
                         <p className="text-center text-sm text-gray-500 mt-4">Loading tenants...</p>
                    ) : error ? (
                         <p className="text-center text-sm text-red-500 mt-4">{error}</p>
                    ) : tenants.length === 0 ? (
                         <p className="text-center text-sm text-gray-500 mt-4">No past tenants found.</p>
                    ) : (
